...
load-zeebe:
	@docker pull camunda/zeebe:8.6.0-alpha4
	@kind load docker-image camunda/zeebe:8.6.0-alpha4 --name ${CLUSTER} --nodes ${CLUSTER}-worker2,${CLUSTER}-worker3,${CLUSTER}-worker4,${CLUSTER}-worker5
