...
load-zeebe:
	@docker pull camunda/zeebe:8.4.6
	@kind load docker-image camunda/zeebe:8.4.6 --name ${CLUSTER} --nodes ${CLUSTER}-worker2,${CLUSTER}-worker3,${CLUSTER}-worker4,${CLUSTER}-worker5
